		...
		for (i = 0; i < queues; ++i) {
			...
			if (nb_rx > 0) {
				...
				if (acl_search.num_ipv4) {
					...
					send_packets_always(acl_search.m_ipv4, acl_search.res_ipv4, acl_search.num_ipv4,  portid);
				...
				if (acl_search.num_ipv6) {
					...
					send_packets_always(acl_search.m_ipv6, acl_search.res_ipv6, acl_search.num_ipv6, portid);
